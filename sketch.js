...
function paintTerrain(noiseValue, index) {
  ...
  if (useGreyScale) {
    // We want to convert this to be from 0 to 255
...
function getTerrainTile(noiseValue) {
  // we have a value between 0 and 1.
  // If it's close to 0, make it water
  // The closer to 1 it gets, the higher it should be
